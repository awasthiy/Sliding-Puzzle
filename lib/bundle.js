...
/***/ function(module, exports, __webpack_require__) {
	...
	Board.prototype.move = function (pos) {
	  ...
	  return {
	    "pos" : pos,
	    "value" : this.grid[currentEmpty],
	    "direction" : Board.determineDirection(currentEmpty , pos, this.gridSize)
	  };
	};
	  ...
	  while (currentNode) {
	    ...
	    boardQueue.add(nextBoards.map(function (board) {
	      ...
	      nextNode.move = {
	        ...
	        "value" : currentBoard.grid[board.emptyPosition],
	        "direction" : Board.determineDirection(
	                        currentBoard.emptyPosition,
	                        board.emptyPosition,
	                        board.gridSize)
	      };
